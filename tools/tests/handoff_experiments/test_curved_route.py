...
ROUTE_FILE = Path("/tmp/test_curved_route.yaml")
RECORD_FILE = Path("/tmp/test_curved_recorded_route.yaml")
LOG_FILE = Path("/tmp/test_curved_route.log")
...
def build_route_points():
    ...
    for index in range(1, 13):
        points.append((4.0, 2.0 + 0.25 * index))
