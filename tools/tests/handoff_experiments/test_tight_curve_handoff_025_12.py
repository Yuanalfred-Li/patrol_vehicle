...
ROUTE_FILE = Path("/tmp/test_tight_curve_handoff_025_12.yaml")
RECORD_FILE = Path("/tmp/test_tight_curve_handoff_025_12_recorded.yaml")
LOG_FILE = Path("/tmp/test_tight_curve_handoff_025_12_launch.log")
...
try:
    ...
    while (
        ...
        if (
            ...
            # 模拟当前实车入轨交接状态：
            # 横向误差约0.25 m，航向误差约12.0度。
            north += 0.25
            ros_yaw += math.radians(12.0)
