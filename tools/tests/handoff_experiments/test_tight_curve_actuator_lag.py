...
ROUTE_FILE = Path("/tmp/test_tight_curve_actuator_lag.yaml")
RECORD_FILE = Path("/tmp/test_tight_curve_actuator_lag_recorded.yaml")
LOG_FILE = Path("/tmp/test_tight_curve_actuator_lag_launch.log")
...
# 仿真压力参数，不代表已标定的实车数据。
STEERING_DELAY_SEC = 0.30
STEERING_RATE_LIMIT_PER_SEC = 500.0
